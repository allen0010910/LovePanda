...
public class MyConfig extends JFinalConfig {
	...
	public void configConstant(Constants me) {
		...
		me.setUploadedFileSaveDirectory(PathKit.getWebRootPath() + "/attached/temp");
	...
	public void afterJFinalStart() {
		...
		JFinal.me().getServletContext().setAttribute("duoshuoShortName", PropKit.get("duoshuoShortName"));
		// 是否开放注册
		JFinal.me().getServletContext().setAttribute("systemRegisterOpen", PropKit.get("systemRegisterOpen"));
		// 是否开放普通用户写博客，传美图，发视频
