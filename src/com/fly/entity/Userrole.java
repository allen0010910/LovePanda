...
public class Userrole extends Model<Userrole> {
	...
	public Page<Userrole> findByRoleId(int pageNumber, int pageSize, int role_id) {
		return paginate(pageNumber, pageSize, "select *", "from userrole where role_id=?", role_id);
	}
