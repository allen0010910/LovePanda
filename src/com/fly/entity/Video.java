...
public class Video extends Model<Video> {
	...
	public Page<Video> paginate(int pageNumber, int pageSize) {
		return paginate(pageNumber, pageSize, "select * ", "from video order by level desc, create_time desc");
	}
	...
	public Page<Video> paginateMyVideo(Integer pageNumber, int pageSize, int userId) {
		return paginate(pageNumber, pageSize, "select * ",
				"from video where user_id=? order by level desc, create_time desc", userId);
	}
	...
	// ============admin=============
	public Page<Video> adminPaginatListVideos(int pageNumber, int pageSize, String sql) {
		return paginate(pageNumber, pageSize, "select * ",
