...
public class Utility {
	...
	/** 18位身份证号码的校验码数组 */
	private static final char[] ID_CARD_CHECK_CODE = new char[] { '1', '0', 'X', '9', '8', '7', '6', '5', '4', '3',
			'2' };
	 ...
	 * 转换字符编码为指定的编码
	 */
	public static String convertEncoding(String str, String encodingFrom, String encodingTo) {
		try {
	 ...
	 * 
	 * @param id_card
	 *            要进行校验的18位身份证号码，15位旧的身份证号码不能进行校验，将返回false
	...
	public static boolean isIDCard18Valid(String id_card) {
		...
		if (id_card.length() == 18) {
			...
			int sum = 0;
			for (int i = 0; i < 17; i++)
				sum += Character.getNumericValue(id_card.charAt(i)) * ID_CARD_WI[i];
