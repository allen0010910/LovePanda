...
public class ImageMagicUtil {
	 ...
	 */
	public static void width(String src, String dest, int width) throws Exception {
	 ...
	 * 定高定宽制作缩略图，对原图做等比例剪裁
	 */
	public static void resize(String src, String dest, int width, int height) throws Exception {
		BufferedImage image = ImageIO.read(new File(src));
		if (image != null) {
	...
	public static void cutImage(String srcPath, String newPath, int x, int y, int w, int h) throws Exception {
		int width = w;
		int height = h;
		ConvertCmd convert = new ConvertCmd();
		convert.setSearchPath(PropKit.get("ImageMagickPath"));
