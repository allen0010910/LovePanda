...
<%@ include file="/WEB-INF/content/common/taglib.jsp"%>
  ...
  <meta name="description" content="主要是分享java和HTML相关的知识。本站采用java的JFinal框架和Amaze UI前端UI框架自主开发而成，网站会不定时更新新的模块和功能。当功能完善后会考虑开源。">
	    ...
	    <div class="am-u-md-8">
			...
			<c:if test="${fn:length(blogList)>0}">
				<div class="wygg">
			        <dd>更多精彩<s></s></dd>
					<ul>
						<li><a href="${base}/blog/">阅读更多博客请进入，点我进入 !</a></li>
					</ul>
				 </div>
			</c:if>
